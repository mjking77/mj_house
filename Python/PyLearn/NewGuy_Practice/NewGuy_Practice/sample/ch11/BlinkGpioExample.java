...
public class BlinkGpioExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // create gpio controller 建立GPIO 的控制
        ...
        myButton.addListener(new GpioPinListenerDigital() {
         ...
         System.out.println(" ... the LED will continue blinking until the  program is termina$
         System.out.println(" ... PRESS <CTRL-C> TO STOP THE PROGRAM.");
          ...
          for (;;) {
            ...
            // (this method will forcefully shutdown all GPIO monitoring  threads and scheduled t$
             // gpio.shutdown(); <--- implement this method call if you wish   to terminate the P$
   }
}
